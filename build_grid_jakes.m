function [Grid] = build_grid_jakes(Grid)
% Description:
...
% Boundary edges
Grid.dof_e_xmin = 1:Grid.Ny+1;  
Grid.dof_e_xmax = Grid.Nx*(Grid.Ny+1) + Grid.dof_e_xmin;
Grid.dof_e_ymin = 1 + [1:Grid.Nx-1]*(Grid.Ny+1);  
Grid.dof_e_ymax = Grid.Ny + Grid.dof_e_ymin;
% get the dimension correct
Grid.dof_e_ymin = Grid.dof_e_ymin';  Grid.dof_e_ymax = Grid.dof_e_ymax';
Grid.dof_e_xmin = Grid.dof_e_xmin';  Grid.dof_e_xmax = Grid.dof_e_xmax';
